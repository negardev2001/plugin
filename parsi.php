...
class PARSI_Plugin {
    ...
    public function register_settings() {
        ...
        add_settings_field(
            'parsi_packaging_type',
            __('نوع بسته‌بندی', 'parsi'),
            array($this, 'render_packaging_type_field'),
            'parsi-settings',
            'parsi_shipping_defaults_section'
        );
    ...
    public function render_handling_fee_field() {
        ...
        ?>
        <div class="parsi-form-row">
            <label class="parsi-form-label"><?php esc_html_e('کارمزد بسته‌بندی', 'parsi'); ?></label>
            <input type="number" name="parsi_handling_fee" value="<?php echo esc_attr($value); ?>" step="0.01" min="0" class="parsi-form-input" placeholder="0.00" />
            <p class="parsi-field-description"><?php esc_html_e('کارمزد اضافی برای افزودن به هزینه ارسال (اختیاری).', 'parsi'); ?></p>
        </div>
        <?php
    }
